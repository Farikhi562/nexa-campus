      ...
      <article className="mx-auto max-w-3xl rounded-lg border border-slate-200 bg-white p-8 shadow-sm">
        ...
        <div className="mt-8 space-y-6 text-sm leading-7 text-slate-700">
          ...
          <section>
            ...
            <p>NEXA mengumpulkan data akun, email, profil akademik (nama, jurusan, universitas, provinsi), dokumen belajar, jadwal ujian, reminder, aktivitas marketplace, hasil exam, streak belajar, badge pencapaian, data tim belajar, notifikasi in-app, log error anonim, dan data teknis yang diperlukan untuk menjalankan layanan.</p>
          </section>

          <section>
            <h2 className="mb-2 text-lg font-black text-slate-950">Dokumen dan Pemrosesan AI</h2>
            <p>Dokumen yang diunggah digunakan untuk memproses ekstraksi teks, ringkasan otomatis, pembuatan soal latihan, dan fitur Chat with PDF. Teks hasil ekstraksi disimpan di database untuk memungkinkan fitur AI berjalan tanpa perlu memproses ulang dokumen. Pemrosesan AI dilakukan menggunakan Google Gemini. Pengguna dilarang mengunggah data sensitif seperti KTP, kartu keluarga, data kesehatan, data keuangan, password, rahasia dagang, dokumen yang melanggar hak cipta, atau data pribadi orang lain tanpa izin.</p>
          </section>
          ...
          <section>
            ...
            <p>Saat pengguna bergabung atau membuat tim belajar, nama dan profil publik mereka dapat dilihat oleh anggota tim yang sama. Pesan dalam chat tim disimpan di database NEXA. Dokumen yang dibagikan ke tim dapat diakses oleh seluruh anggota tim selama izin berbagi aktif. Pengguna dapat keluar dari tim kapan saja melalui pengaturan tim.</p>
          </section>
          ...
          <section>
            ...
            <p>Pembayaran diproses melalui DOKU atau proses operasional admin. NEXA tidak menyimpan data kartu pembayaran di aplikasi. Data transaksi disimpan untuk keperluan verifikasi aktivasi paket dan pengajuan refund.</p>
          </section>

          <section>
            <h2 className="mb-2 text-lg font-black text-slate-950">Log Error dan Keamanan</h2>
            <p>NEXA menyimpan log error anonim untuk keperluan debugging dan peningkatan layanan. Log ini mencatat jenis error dan waktu kejadian, tanpa menyimpan isi dokumen, jawaban ujian, atau informasi sensitif pengguna. Rate limiting diterapkan pada semua endpoint API untuk melindungi layanan dari penyalahgunaan.</p>
          </section>
