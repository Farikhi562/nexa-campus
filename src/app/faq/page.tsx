...
const FAQ_GROUPS = [
  {
    ...
    icon: ShieldCheck,
    items: [
      ['NEXA Campus v1.0 itu apa?', 'NEXA Campus Ecosystem v1.0 adalah platform mahasiswa untuk belajar dari dokumen, latihan mock exam, mengatur reminder akademik, membuka marketplace kampus, dan memakai AI Campus Tools. Tersedia fitur kolaborasi tim belajar, leaderboard antar kampus, dan analisis kelemahan belajar berbasis AI.'],
