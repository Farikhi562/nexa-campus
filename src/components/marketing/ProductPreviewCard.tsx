      ...
      <div className="relative aspect-[16/10] overflow-hidden bg-slate-950">
        {!imageFailed ? (
          ...
          <div className="relative flex h-full flex-col justify-between p-5 text-white">
            <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_75%_18%,rgba(96,165,250,0.28),transparent_16rem)]" />
            <div className="relative flex items-center justify-between">
              <Badge tone="info" className="bg-orange-200/10 text-orange-100 ring-orange-200/20">
                Contoh tampilan
              </Badge>
              ...
              <div className="grid grid-cols-3 gap-2">
                {[1, 2, 3].map((item) => (
                  <div key={item} className="rounded-2xl border border-white/10 bg-white/[0.07] p-3">
                    <div className="h-3 w-10 rounded-full bg-blue-200/50" />
