    ...
    <section className="relative overflow-hidden rounded-3xl border border-slate-200 bg-slate-950 p-5 text-white shadow-xl shadow-slate-200">
      ...
      <div className={isCommand ? 'relative' : 'relative select-none blur-[2px]'}>
        <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
          ...
          <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-blue-300/10 text-blue-200">
              ...
              return (
                <article key={deadline.id} className="rounded-2xl border border-white/10 bg-white/[0.06] p-4">
                  <div className="flex items-center justify-between gap-3">
                    <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-blue-300/10 text-sm font-black text-blue-100">
                      {index + 1}
                    </div>
                  ...
                  <div className="mt-4 flex gap-2 text-xs leading-5 text-slate-300">
                    {index === 0 ? <Zap className="mt-0.5 h-4 w-4 flex-shrink-0 text-amber-200" /> : <Target className="mt-0.5 h-4 w-4 flex-shrink-0 text-blue-200" />}
                    <p>
                      {index === 0
        ...
        <div className="mt-5 flex flex-col gap-3 sm:flex-row">
          <Link
            ...
            className="inline-flex min-h-11 items-center justify-center gap-2 rounded-2xl bg-blue-400 px-4 py-3 text-sm font-black text-slate-950 hover:bg-blue-300"
          >
      ...
      {!isCommand && (
        <div className="absolute inset-0 flex items-center justify-center bg-slate-950/70 p-4 backdrop-blur-sm">
          <div className="max-w-md rounded-3xl border border-white/10 bg-slate-950 p-6 text-center shadow-2xl">
            <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-2xl bg-blue-300/10 text-blue-200">
            ...
            <Link href="/pricing" className="mt-5 inline-flex rounded-2xl bg-blue-400 px-4 py-3 text-sm font-black text-slate-950 hover:bg-blue-300">
              Lihat Command
            </Link>
          </div>
        </div>
