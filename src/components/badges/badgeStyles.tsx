export default function BadgeStyles() {
  return (
    <style jsx global>{`
      ...
      .nexa-badge-langka {
        background:
          radial-gradient(circle at 18% 12%, rgba(14, 165, 233, 0.22), transparent 30%),
          linear-gradient(135deg, #f0f9ff 0%, #e0f2fe 54%, #f8fafc 100%) !important;
      }

      .nexa-badge-epic {
        background:
          radial-gradient(circle at 20% 18%, rgba(168, 85, 247, 0.22), transparent 32%),
          linear-gradient(135deg, #faf5ff 0%, #ede9fe 56%, #fff7ed 100%) !important;
      }
      ...
      .nexa-badge-epic .nexa-badge-medal {
        animation: nexaEpicPulse 3.4s ease-in-out infinite;
      }

      .nexa-badge-legend {
        background:
          radial-gradient(circle at 18% 18%, rgba(251, 191, 36, 0.35), transparent 30%),
          linear-gradient(135deg, #fff7ed 0%, #fef3c7 50%, #fde68a 100%) !important;
      }
      ...
      .nexa-badge-legend .nexa-badge-medal {
        animation: nexaLegendFloat 2.8s ease-in-out infinite;
      }
      ...
      .nexa-badge-mythos .nexa-badge-shine {
        background:
          linear-gradient(120deg, transparent 5%, rgba(255, 255, 255, 0.45) 18%, transparent 32%, transparent 100%);
      ...
      @keyframes nexaMythosMedal {
        ...
        50% { transform: translateY(-5px) rotate(2deg) scale(1.085); filter: hue-rotate(60deg); }
      }
