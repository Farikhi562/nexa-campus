  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div
          role="menu"
          className="absolute right-0 z-[70] mt-2 w-56 max-w-[calc(100vw-1.5rem)] overflow-hidden rounded-2xl border border-slate-200 bg-white p-1.5 shadow-2xl shadow-slate-950/10"
          style={{ right: 0 }}
        >
