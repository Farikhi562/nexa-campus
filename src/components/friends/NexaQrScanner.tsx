  ...
  if (!open) {
    return (
      <button
        type="button"
        onClick={start}
        className="inline-flex min-h-11 items-center justify-center gap-2 rounded-2xl border border-teal-200 bg-white px-4 py-3 text-sm font-black text-teal-700 shadow-sm transition hover:bg-teal-50"
      >
  ...
  return (
    <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
      ...
      <div className="mt-3 flex gap-2">
        ...
        />
        <button type="button" onClick={submitManual} className="rounded-2xl bg-teal-500 px-4 py-2 text-sm font-black text-slate-950 hover:bg-teal-400">
          Cari
        </button>
      </div>
