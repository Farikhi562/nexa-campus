...
const variants: Record<ButtonVariant, string> = {
  primary:
    'bg-gradient-to-r from-brand-600 to-cyan-500 text-white shadow-lg shadow-brand-500/20 hover:from-brand-700 hover:to-cyan-600',
  secondary: 'bg-slate-950 text-white shadow-lg shadow-slate-900/15 hover:bg-slate-800',
  outline:
    'border border-slate-200 bg-white text-slate-700 shadow-sm hover:border-brand-200 hover:bg-brand-50 hover:text-brand-800',
