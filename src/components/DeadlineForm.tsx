...
export default function DeadlineForm({
  ...
  return (
    <form onSubmit={submit} className="space-y-4 pb-24 sm:pb-0">
      ...
      <div className="fixed inset-x-0 z-[60] border-t border-white/80 bg-white/95 p-3 shadow-2xl shadow-slate-900/10 backdrop-blur-xl sm:static sm:bottom-auto sm:z-auto sm:border-0 sm:bg-transparent sm:p-0 sm:shadow-none"
